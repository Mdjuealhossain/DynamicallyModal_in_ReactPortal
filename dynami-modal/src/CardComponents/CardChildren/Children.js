...
const Card = () => {
    ...
    return (
        <div>
            ...
            <button onClick={handleOpen}>Open Card1</button>
            <Modal isOpen={show} handleClose={handleClose}>
                <div>
                    <h1>Modal 1</h1>
                    <p>Thanks using context is absolutely new for me. I have one perhaps silly question, in componenet called Catalogue</p>
                </div>
            </Modal>
        </div>
    )
